...
CMD groupadd -g $host_gid container_group && \
    ...
    sed -i "s|{{xdebug_port}}|$xdebug_port|" /etc/php/7.3/apache2/conf.d/20-xdebug.ini && \
    sed -i "s|{{xdebug_remote_host}}|$xdebug_remote_host|" /etc/php/7.3/apache2/conf.d/20-xdebug.ini && \
    sed -i "s|{{xdebug_port}}|$xdebug_port|" /etc/php/7.3/cli/conf.d/20-xdebug.ini && \
    sed -i "s|{{xdebug_remote_host}}|$xdebug_remote_host|" /etc/php/7.3/cli/conf.d/20-xdebug.ini && \
